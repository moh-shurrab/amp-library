...
class ValidationRulesFactory {
  ...
  $o_9751 = new TagSpec();
  $o_9751->tag_name = 'script';
  $o_9751->spec_name = 'amp-tiktok extension .js script';
  $o_9751->mandatory_parent = 'head';
  $o_9761 = new AttrSpec();
  $o_9761->name = 'async';
  $o_9761->mandatory = true;
  $o_9761->value = '';
  $o_9751->attrs[] = $o_9761;
  $o_9771 = new AttrSpec();
  $o_9771->name = 'custom-element';
  $o_9771->mandatory = true;
  $o_9771->value = 'amp-tiktok';
  $o_9771->dispatch_key = true;
  $o_9751->attrs[] = $o_9771;
  $o_9781 = new AttrSpec();
  $o_9781->name = 'src';
  $o_9781->mandatory = true;
  $o_9781->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-tiktok-(latest|0\\.1).js';
  $o_9751->attrs[] = $o_9781;
  $o_9791 = new AttrSpec();
  $o_9791->name = 'type';
  $o_9791->value = 'text/javascript';
  $o_9751->attrs[] = $o_9791;
  $o_9751->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-tiktok.html';
  $o_9801 = new CdataSpec();
  $o_9811 = new BlackListedCDataRegex();
  $o_9811->regex = '.';
  $o_9811->error_message = 'contents';
  $o_9801->blacklisted_cdata_regex[] = $o_9811;
  $o_9751->cdata = $o_9801;
  $o_0->tags[] = $o_9751;
  $o_9821 = new TagSpec();
  $o_9821->tag_name = 'amp-tiktok';
  $o_9831 = new AttrSpec();
  $o_9831->name = 'data-tweetid';
  $o_9831->mandatory_oneof = '[\'data-src\']';
  $o_9821->attrs[] = $o_9831;
  $o_9841 = new AttrSpec();
  $o_9841->name = 'src';
  $o_9841->mandatory_oneof = '[\'data-src\']';
  $o_9851 = new UrlSpec();
  $o_9851->allowed_protocol = ['http', 'https'];
  $o_9851->allow_relative = true;
  $o_9841->value_url = $o_9851;
  $o_9821->attrs[] = $o_9841;
  $o_9821->attr_lists = ['extended-amp-global'];
  $o_9821->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-tiktok.html';
  $o_9861 = new AmpLayout();
  $o_9861->supported_layouts = [AmpLayoutLayout::FILL, AmpLayoutLayout::FIXED, AmpLayoutLayout::FIXED_HEIGHT, AmpLayoutLayout::FLEX_ITEM, AmpLayoutLayout::NODISPLAY, AmpLayoutLayout::RESPONSIVE];
  $o_9821->amp_layout = $o_9861;
  $o_9821->disallowed_ancestor = ['head', 'amp-sidebar'];
  $o_9821->also_requires_tag = ['amp-tiktok extension .js script'];
  $o_0->tags[] = $o_9821;
  return $o_0;
  }
}
